...
public class DatabaseMetaData implements java.sql.DatabaseMetaData {
	...
	private final static String DRIVER_NAME = "Humio JDBC Driver";
	private final static String DRIVER_VERSION = "0.1";
	private final static int DRIVER_MAJOR_VERSION = 0;
	private final static int DRIVER_MINOR_VERSION = 1;
	
	// Riak TS Product Variables
	// Note: Update version a new version is released and 
	// tested with the driver
	private final static String DATABASE_PRODUCT_NAME = "Humio";
	private final static String DATABASE_PRODUCT_VERSION = "1.X";
